...
import { API_SDK, INTERFACE_DEV_DOC, PROD_LINK } from '@/constant';
import { getUserByInvitationCodeUsingPost } from '@/services/FrankApi/userController';
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Title level={3}> {loginUser?.userAccount}，欢迎使用 FrankApi 接口开放平台 🎉</Title>
          </div>
          <div
            style={{
              fontSize: '14px',
          ...
          >
            <Text strong>
              <Title level={4}>
                FrankApi 接口开放平台是一个为用户和开发者提供全面 API 接口调用服务的平台 🛠
              </Title>
              <Title level={5}>
                😀
                ...
                <br />
                😄 作为开发者 我们提供了
                <a href={API_SDK} target="_blank" rel="noreferrer">
                  客户端 SDK
                </a>
                ， 通过
                ...
                <br />
                🤝 您可以将自己的接口接入到 FrankApi 接口开放平台平台上，并发布给其他用户使用。
                您可以管理和各个接口，以便更好地分析和优化接口性能。
                <br />
                📝 我们还提供了
                <a href={INTERFACE_DEV_DOC} target={'_blank'} rel="noreferrer">
                  开发者在线文档
                </a>
                和技术支持，帮助您快速接入和发布接口。
                <br />
                👨‍💻 无论您是用户还是开发者，FrankApi
